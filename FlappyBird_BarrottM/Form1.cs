...
namespace FlappyBird_BarrottM
{
    public partial class Form1 : Form
    {
        ...
        private MciPlayer gameEnd = new MciPlayer("sounds/GameEndSound.wav","end");
        ...
        private void gameTimerEvent(object sender, EventArgs e)
        {
            ...
            scoreText.Text = "Score: " + score + "  Spacebar to Fly"; // show the current score on the score text label
        ...
        private void endGame()
        {
            ...
            gameEnd.PlayFromStart();
            gameTimer.Stop(); // stop the main timer
            scoreText.Text = " Game over!!!  Score: " + score;// show the game over text on the score text, += is used to add the new string of text next to the score instead of overriding it
        ...
        private void gamekeyisdown(object sender, KeyEventArgs e)
        {
            ...
            {
                // if the space key is pressed then the gravity will be set to -12
                gravity = -12;
            }
